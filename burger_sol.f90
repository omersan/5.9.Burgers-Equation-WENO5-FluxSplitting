...
do i=3,nx-2
cc(i) = max(dabs(u(i-2)),dabs(u(i-1)),dabs(u(i)),dabs(u(i+1)),dabs(u(i+2)))
end do
!periodicity
i=1
cc(i) = max(dabs(u(i-2+nx)),dabs(u(i-1+nx)),dabs(u(i)),dabs(u(i+1)),dabs(u(i+2)))
i=2
cc(i) = max(dabs(u(i-2+nx)),dabs(u(i-1)),dabs(u(i)),dabs(u(i+1)),dabs(u(i+2)))
i=nx-1
cc(i) = max(dabs(u(i-2)),dabs(u(i-1)),dabs(u(i)),dabs(u(i+1)),dabs(u(i+2-nx)))
i=nx
cc(i) = max(dabs(u(i-2)),dabs(u(i-1)),dabs(u(i)),dabs(u(i+1-nx)),dabs(u(i+2-nx)))
